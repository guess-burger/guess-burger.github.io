...
Elm.Main.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var textarea_style = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "resize",_1: "none"}
   ...
   var format_time = function (x) {
      var _p0 = x;
      var name = _p0._0;
      var total_mins = _p0._1;
      var hrs = total_mins / 60 | 0;
      var string_hrs = $Basics.toString(hrs);
      var mins = A2($Basics._op["%"],total_mins,60);
   ...
   var time_collect = F2(function (x,dict) {
      ...
      var name = _p1._0;
      var mins = _p1._1;
      var _p2 = A2($Dict.get,name,dict);
      if (_p2.ctor === "Just") {
            return A3($Dict.insert,name,_p2._0 + mins,dict);
         } else {
            return A3($Dict.insert,name,mins,dict);
         }
   });
   var to_minutes = function (x) {
      var _p3 = x;
      var before = _p3._0;
      var after = _p3._1;
      var _p4 = before;
      ...
      var a_hr = _p5._0;
      var a_min = _p5._1;
      var mins = (a_hr - b_hr) * 60 + a_min - b_min;
      return {ctor: "_Tuple2",_0: b_name,_1: mins};
   };
   var zip_self = function (list) {
      var _p6 = list;
      if (_p6.ctor === "::") {
            return A3($List.map2,F2(function (a,b) {    return {ctor: "_Tuple2",_0: a,_1: b};}),list,_p6._1);
         } else {
            return _U.list([]);
         }
   };
   ...
   var valid_time_values = function (x) {
      ...
      var min = _p7._1;
      var name = _p7._2;
      return _U.cmp(hr,0) > -1 && (_U.cmp(hr,24) < 0 && (_U.cmp(min,0) > -1 && _U.cmp(min,60) < 0)) ? $Maybe.Just({ctor: "_Tuple3"
                                                                                                                  ,_0: hr
                                                                                                                  ,_1: min
                                                                                                                  ,_2: name}) : $Maybe.Nothing;
   };
   var numeric_min_hours = function (x) {
      var _p8 = x;
      var time = _p8._0;
      var name = _p8._1;
      var hours = A2($String.left,2,time);
      var num_hours_result = $String.toInt(hours);
      var mins = A2($String.right,2,time);
      var num_mins_result = $String.toInt(mins);
      var _p9 = {ctor: "_Tuple2",_0: num_hours_result,_1: num_mins_result};
      if (_p9.ctor === "_Tuple2" && _p9._0.ctor === "Ok" && _p9._1.ctor === "Ok") {
            return $Maybe.Just({ctor: "_Tuple3",_0: _p9._0._0,_1: _p9._1._0,_2: name});
         } else {
            return $Maybe.Nothing;
         }
   };
   var valid_time_length = function (_p10) {
      var _p11 = _p10;
      var _p12 = _p11._0;
      return _U.eq($String.length(_p12),4) ? $Maybe.Just({ctor: "_Tuple2",_0: _p12,_1: _p11._1}) : $Maybe.Nothing;
   };
   var maybe_two = function (n) {
      var _p13 = n;
      if (_p13.ctor === "[]") {
            return $Maybe.Nothing;
         } else {
            if (_p13._1.ctor === "::" && _p13._1._1.ctor === "[]") {
                  return $Maybe.Just({ctor: "_Tuple2",_0: _p13._0,_1: _p13._1._0});
               } else {
                  return $Maybe.Nothing;
               }
         }
