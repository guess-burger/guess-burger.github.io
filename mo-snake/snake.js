...
Elm.Main.make = function (_elm) {
   ...
   var render = F2(function (_p1,state) {
      ...
      A2($Graphics$Element.color,$Color.white,A3($Graphics$Collage.collage,600,600,A2($List.concatMap,render_snake,state.snakes)))));
   });
   ...
   function (v) {
      return typeof v === "object" && "snakes" in v ? {_: {}
                                                      ,snakes: typeof v.snakes === "object" && v.snakes instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.snakes.map(function (v) {
                                                         return typeof v === "object" && "points" in v && "colour" in v ? {_: {}
   ...
   var Snake = F2(function (a,b) {    return {points: a,colour: b};});
